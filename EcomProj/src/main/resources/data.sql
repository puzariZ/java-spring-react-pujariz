INSERT INTO PRODUCT (name, description, brand, price, category, release_date, is_available, quantity) VALUES
                                    ...
                                    ('Toyota Fortuner', 'A premium SUV with a bold looks and design made only for politicians', 'Toyota', 5100000.00, 'Cars', '2024-05-01', true, 30);